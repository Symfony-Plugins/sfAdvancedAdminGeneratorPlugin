 ...
 */
 $createActions = $this->getParameterValue('create.actions');
?>
  <?php if (null === $createActions || (null !== $createActions && array_key_exists('_delete', $createActions))): ?>
    <?php echo $this->addCredentialCondition($this->getButtonToAction('_delete', $createActions['_delete'], true), $createActions['_delete']) ?>
  <?php endif; ?>
</ul>
